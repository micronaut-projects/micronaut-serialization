...
abstract class DeserializationEntity {
    ...
    private static CodeBlock getCreatorCall(GeneratorType type, SerializableBeanDefinition definition, CodeBlock creatorParameters) {
    ...
    static DeserializationEntity introspect(
        ...
        SerializableBeanDefinition def = symbol.introspect(generatorContext.getProblemReporter(), type, false);
        if (def.creatorDelegatingProperty != null) {
            ...
            Map<SerializableBeanDefinition.Property, DeserializationEntity> elements = new LinkedHashMap<>();
            for (SerializableBeanDefinition.Property prop : def.props) {
    ...
    private static class Delegating extends DeserializationEntity {
        ...
        final SerializableBeanDefinition beanDefinition;
        final PropWithType prop;
        final SerializerSymbol symbol;

        Delegating(GeneratorType type, SerializableBeanDefinition beanDefinition, PropWithType prop, SerializerSymbol symbol) {
            this.type = type;
    ...
    private static class Structure extends DeserializationEntity {
        ...
        private final SerializableBeanDefinition definition;
        private final Map<SerializableBeanDefinition.Property, DeserializationEntity> elements;
        @Nullable
        private AnySetterAsMap anySetterAsMap;

        private Structure(GeneratorType type, SerializableBeanDefinition definition, Map<SerializableBeanDefinition.Property, DeserializationEntity> elements, AnySetterAsMap anySetterAsMap) {
            this.type = type;
        ...
        @Override
        void updateChildren(Function<DeserializationEntity, DeserializationEntity> function) {
            for (Map.Entry<SerializableBeanDefinition.Property, DeserializationEntity> entry : elements.entrySet()) {
        ...
        void allocateLocals(GeneratorContext context, String ownNameHint) {
            ...
            for (Map.Entry<SerializableBeanDefinition.Property, DeserializationEntity> element : elements.entrySet()) {
        ...
        void generateEpilogue(GeneratorContext generatorContext, CodeBlock.Builder builder, InlineBitSet<DeserializationEntity> readProperties, String decoderVariable) {
            ...
            for (SerializableBeanDefinition.Property prop : definition.creatorProps) {
                if (!firstParameter) {
            ...
            for (SerializableBeanDefinition.Property prop : definition.props) {
    ...
    private static class SubtypingFlat extends DeserializationEntity {
        ...
        SubtypingFlat(
                ...
                SerializableBeanDefinition definition,
                ConditionExpression<String> allowDeserializationCheck) {
            this.superType = superType;
