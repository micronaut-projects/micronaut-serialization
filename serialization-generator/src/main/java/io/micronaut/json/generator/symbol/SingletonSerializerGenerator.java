...
public final class SingletonSerializerGenerator {
    ...
    private GenerationResult generateClass(boolean serializer, boolean deserializer, ClassName generatedName) {
        ...
        if (deserializer) {
            ...
            if (symbol.supportsNullDeserialization()) {
                builder.addMethod(MethodSpec.methodBuilder("allowNull")
                        .addAnnotation(Override.class)
                        .addModifiers(Modifier.PUBLIC)
                        .returns(boolean.class)
                        .addCode("return true;\n")
        ...
        Map<String, GenericPlaceholderElement> freeVariableNames = freeVariables.stream().collect(Collectors.toMap(GenericPlaceholderElement::getVariableName, (v) -> v));

        TypeSpec.Builder factoryType = buildSerializerFactory(freeVariableNames);
    ...
    private TypeSpec.Builder buildSerializerFactory(Map<String, GenericPlaceholderElement> placeholderElementMap) {
