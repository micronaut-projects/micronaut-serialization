...
public interface SerializerSymbol {
     ...
     */
    default ConditionExpression<CodeBlock> shouldIncludeCheck(
            GeneratorContext generatorContext,
            GeneratorType type,
            JsonInclude.Include inclusionPolicy) {
    ...
    interface DependencyVisitor {
        ...
        void visitStructureElement(
                SerializerSymbol dependencySymbol,
                GeneratorType dependencyType,
