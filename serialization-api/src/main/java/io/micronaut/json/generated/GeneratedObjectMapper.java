...
public final class GeneratedObjectMapper implements JsonMapper {
    ...
    private final SerdeRegistry locator;
    ...
    private GeneratedObjectMapper(SerdeRegistry locator, JsonStreamConfig deserializationConfig, Class<?> view) {
    ...
    @Inject
    @Internal
    public GeneratedObjectMapper(SerdeRegistry locator) {
