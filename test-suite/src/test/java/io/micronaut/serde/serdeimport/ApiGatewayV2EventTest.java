...
class ApiGatewayV2EventTest {
    ...
    void testDeserializationOfAPIGatewayV2HttpEvent() throws IOException {
        ...
        APIGatewayV2HTTPEvent event = assertDoesNotThrow(() -> fromJson(jsonMapper, json, APIGatewayV2HTTPEvent.class));
        expectedEvent(event);
    }

    public <T> T fromJson(JsonMapper jsonMapper, String input, Type type) throws IOException {
