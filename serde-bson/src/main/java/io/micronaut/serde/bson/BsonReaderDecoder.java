...
public final class BsonReaderDecoder extends AbstractStreamDecoder {
    ...
    /**
     * BsonReader that correctly remembers the last token.
     */
    private final class BsonReaderMemorized implements BsonReader {

        private final BsonReader reader;
        private BsonType currentBsonType;

        private BsonReaderMemorized(BsonReader reader) {
            this.reader = reader;
            this.currentBsonType = reader.getCurrentBsonType();
        }
        ...
        public byte peekBinarySubType() {
            return reader.peekBinarySubType();
        }

        @Override
        public int peekBinarySize() {
            return reader.peekBinarySize();
        }
        ...
        public long readDateTime(String name) {
            return reader.readDateTime(name);
        }
        ...
        public Decimal128 readDecimal128(String name) {
            return reader.readDecimal128(name);
        }
        ...
        public String readJavaScript(String name) {
            return reader.readJavaScript(name);
        }
        ...
        public String readJavaScriptWithScope(String name) {
            return reader.readJavaScriptWithScope(name);
        }
        ...
        public ObjectId readObjectId(String name) {
            return reader.readObjectId(name);
        }
        ...
        public BsonRegularExpression readRegularExpression(String name) {
            return reader.readRegularExpression(name);
        }
        ...
        public BsonDbPointer readDBPointer(String name) {
            return reader.readDBPointer(name);
        }
        ...
        public BsonTimestamp readTimestamp(String name) {
            return reader.readTimestamp(name);
        }
