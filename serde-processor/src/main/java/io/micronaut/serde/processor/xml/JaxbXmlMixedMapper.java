...
/**
 * Maps {@code @XmlMixed} to unwrapped XML text metadata.
 *
 * @since 3.2
 */
public final class JaxbXmlMixedMapper implements NamedAnnotationMapper {
    @Override
    public String getName() {
        return "jakarta.xml.bind.annotation.XmlMixed";
    }
