...
class CompileTimeSourceGenSpec extends JsonCompileSpec {
    ...
    void 'test generated serializers use object encoder and generated classes use indexed fields'() {
        ...
        beanSerializerSource.contains("withSerializationPropertyPath(e0, type, ${simpleName(beanSerializerClassName)}.ARGUMENT_0)")
        beanSerializerSource.contains("withSerializationPropertyPath(e0, type, ${simpleName(beanSerializerClassName)}.ARGUMENT_1)")
        !recordSerializerSource.contains('propertyArgument')
        recordSerializerSource.contains("withSerializationPropertyPath(e0, type, ${simpleName(recordSerializerClassName)}.ARGUMENT_0)")
        recordSerializerSource.contains("withSerializationPropertyPath(e0, type, ${simpleName(recordSerializerClassName)}.ARGUMENT_1)")
