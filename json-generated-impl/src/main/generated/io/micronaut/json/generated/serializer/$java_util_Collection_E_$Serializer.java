...
final class $java_util_Collection_E_$Serializer<E> implements Serializer<Collection<E>> {
  private final Serializer<? super E> io_micronaut_json_Serializer___super_E_;

  public $java_util_Collection_E_$Serializer(
  ...
  @Override
  public void serialize(Encoder encoder, Collection<E> value) throws IOException {
  ...
  @Override
  public boolean isEmpty(Collection<E> value) {
  ...
  public static final class FactoryImpl implements Serializer.Factory {
    ...
    @Override
    public $java_util_Collection_E_$Serializer newInstance(SerializerLocator locator,
        Function<String, Type> getTypeParameter) {
      return new $java_util_Collection_E_$Serializer(locator.findContravariantSerializer(getTypeParameter.apply("E")));
    }
  }
}
