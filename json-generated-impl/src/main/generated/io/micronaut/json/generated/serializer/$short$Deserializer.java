...
final class $short$Deserializer implements Deserializer<Short> {
  public $short$Deserializer() {
  }

  @Override
  public Short deserialize(Decoder decoder) throws IOException {
  ...
  public static final class FactoryImpl implements Deserializer.Factory {
    ...
    @Override
    public $short$Deserializer newInstance(SerializerLocator locator,
        Function<String, Type> getTypeParameter) {
      return new $short$Deserializer();
    }
  }
}
