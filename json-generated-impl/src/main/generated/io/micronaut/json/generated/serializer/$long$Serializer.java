...
final class $long$Serializer implements Serializer<Long> {
  public $long$Serializer() {
  }

  @Override
  public void serialize(Encoder encoder, Long value) throws IOException {
  ...
  public static final class FactoryImpl implements Serializer.Factory {
    ...
    @Override
    public $long$Serializer newInstance(SerializerLocator locator,
        Function<String, Type> getTypeParameter) {
      return new $long$Serializer();
    }
  }
}
