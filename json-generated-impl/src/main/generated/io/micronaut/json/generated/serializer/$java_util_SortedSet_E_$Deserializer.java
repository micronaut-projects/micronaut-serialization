...
final class $java_util_SortedSet_E_$Deserializer<E> implements Deserializer<SortedSet<E>> {
  private final Deserializer<? extends E> io_micronaut_json_Deserializer___extends_E_;

  public $java_util_SortedSet_E_$Deserializer(
  ...
  @Override
  public SortedSet<E> deserialize(Decoder decoder) throws IOException {
    Decoder arrayDecoder = decoder.decodeArray();
    TreeSet<E> intermediate = new TreeSet<>();
  ...
  public static final class FactoryImpl implements Deserializer.Factory {
    ...
    @Override
    public $java_util_SortedSet_E_$Deserializer newInstance(SerializerLocator locator,
        Function<String, Type> getTypeParameter) {
      return new $java_util_SortedSet_E_$Deserializer(locator.findInvariantDeserializer(getTypeParameter.apply("E")));
    }
  }
}
