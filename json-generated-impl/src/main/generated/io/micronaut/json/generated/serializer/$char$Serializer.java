...
final class $char$Serializer implements Serializer<Character> {
  public $char$Serializer() {
  }

  @Override
  public void serialize(Encoder encoder, Character value) throws IOException {
  ...
  public static final class FactoryImpl implements Serializer.Factory {
    ...
    @Override
    public $char$Serializer newInstance(SerializerLocator locator,
        Function<String, Type> getTypeParameter) {
      return new $char$Serializer();
    }
  }
}
