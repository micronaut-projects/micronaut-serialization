...
import io.micronaut.serde.yaml.tck.AbstractYamlSerializationSpec

class JacksonYamlSerializationSpec extends AbstractYamlSerializationSpec implements JacksonDatabindYamlSpec {
