...
class SpecificObjectDeserializer implements Deserializer<Object>, UpdatingDeserializer<Object> {
    ...
    private final Supplier<DeserBean<? super Object>> deserBean;

    public SpecificObjectDeserializer(boolean ignoreUnknown, Supplier<DeserBean<? super Object>> deserBean) {
    ...
    public Object deserialize(Decoder decoder, DecoderContext decoderContext, Argument<? super Object> type)
        ...
        DeserBean<? super Object> deserBean = this.deserBean.get();
