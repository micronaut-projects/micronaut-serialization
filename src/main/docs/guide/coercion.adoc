...
snippet::example.Item[project-base="doc-examples/example", source="main"]

The document above reads into `id = 1234`, `name = "42"` and `count = 9`:

snippet::example.CoercionTest[project-base="doc-examples/example"]
